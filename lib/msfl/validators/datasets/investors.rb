  ...
  module Validators
    module Datasets
      module Investors
        ...
        #
        def investors_validate_type_conforms(obj, property, errors)
          errors << "Type of #{obj} does not conform to #{property}" unless investors_type_conforms?(obj, property)
          errors
        end
        ...
        # @param obj [Object] the object that should be type checked based on the property argument
        # @param property [Symbol] which property should the object be checked for conformity
        def investors_type_conforms?(obj, property)
          true
        end
        ...
        # @param errors [Array] an array of validation errors - empty indicates that no errors have been encountered
        # @return [Array] errors merged with any validation errors encountered in validating the set
        def investors_validate_operator_conforms(operator, property, errors)
          errors
        end
        ...
        #
        def investors_validate_value_conforms(value, property, errors)
